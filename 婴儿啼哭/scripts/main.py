...
def predict():
    lbl2id = {"uncomfortable": 0, "diaper": 1, "awake": 2, "sleepy": 3, "hug": 4, "hungry": 5}
    ...
    submission = pd.DataFrame({"id": [f.split('/')[-1] for f in test_path_list], "label": [id2lbl[id] for id in preds_list]})
